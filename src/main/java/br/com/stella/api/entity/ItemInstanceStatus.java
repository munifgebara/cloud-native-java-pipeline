...
/**
 * Enumeration representing the possible operational states of an {@link ItemInstance}.
 *
...
public enum ItemInstanceStatus {
    ...
    /**
     * The instance has been loaned to a {@link Person} and is in their possession.
