...
/**
 * Entity representing a physical instance of an {@link MainItem}.
 *
 * <p>While {@link MainItem} describes the "model" of the asset (e.g.: "Dell Laptop"),
...
public class ItemInstance extends BaseEntity {
     ...
     *
     * <p>Ensures that {@link #operationalStatus} is never persisted as {@code null},
     * applying the default value {@link ItemInstanceStatus#DISPONIVEL} if necessary.</p>
     */
    @Override
    @PrePersist
    public void prePersist() {
        ...
        if (operationalStatus == null) {
            operationalStatus = ItemInstanceStatus.DISPONIVEL;
        }
    }
}
